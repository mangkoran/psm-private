...
\Cref{fig:pve_kvm_playbook,fig:pve_kvm_tasks} shows the Ansible group variables, playbook and task
...
\Cref{fig:pve_vars,fig:pve_lxc_playbook,fig:pve_lxc_tasks} shows the Ansible playbook and task to
...
\Cref{fig:vector_config} shows the configuration file for Vector. Vector will filter the
...
\Cref{fig:loki_playbook,loki_tasks} shows the Ansible playbook and task to install and configure
